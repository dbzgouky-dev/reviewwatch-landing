...
jpg_path = "/home/hermes/business/reviewwatch/landing/dashboard_preview.jpg"
img.save(png_path)
print(f"✅ PNG créé : {png_path}")
print(f"   Taille: {os.path.getsize(png_path)/1024:.0f} KB")

img.save(webp_path, "WEBP", quality=85)
print(f"✅ WebP créé : {webp_path} ({os.path.getsize(webp_path)/1024:.0f} KB)")

img.convert('RGB').save(jpg_path, "JPEG", quality=80, optimize=True)
print(f"✅ JPG créé : {jpg_path} ({os.path.getsize(jpg_path)/1024:.0f} KB)")
